...
#define STRING_CONFIG_H_AUTHOR "robotcanadia" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,160,2020,96} // NOTE THIS IS 32 micro on x/y and 16 on z/e
